...
export const metadata: Metadata = {
  title: "상담 신청 | C-BRIDGE",
  description:
    "현재 준비 상황과 목표를 알려주시면 C-BRIDGE가 시험에 맞는 교재를 추천해드립니다. 지금 상담을 신청하세요.",
};
      ...
      <div className="mx-auto grid max-w-[1440px] gap-14 px-5 md:px-10 lg:grid-cols-[1fr_1.4fr]">
        <div>
          ...
          <div className="mt-10 space-y-5 border-t border-purple/10 pt-8">
            ...
            <Step no="02" title="상담 신청" desc="상담 신청서를 작성합니다" />
          ...
          <div className="mt-10 rounded-[20px] border border-purple/15 bg-lavender/20 p-6 text-sm text-ink/70">

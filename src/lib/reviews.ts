...
export const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    tag: "단기 · Speaking 보완",
    quote:
      "시험까지 3주밖에 안 남아서 200P로 주문했어요. Reading은 괜찮고 Speaking이 약하다고 말씀드렸더니 그쪽 위주로 추천해주셔서 훨씬 효율적으로 공부했습니다. 일반 문제집보다 제가 필요한 부분만 집중할 수 있는 점이 좋았어요.",
    author: "듀오링고 200P 구매자",
  },
  {
    id: "sjpt",
    test: "SJPT",
  ...
  },
  {
    ...
    tag: "독해 비중 강화",
    quote:
      "다른 일본어 시험은 준비해봤는데 FLEX는 처음이라 교재 찾기가 어려웠어요. 독해 비중을 높여서 200P로 주문했고, 문제 유형이 다양해서 시험 감 익히는 데 좋았습니다. FLEX처럼 자료가 적은 시험은 이런 맞춤형 구성이 확실히 편한 것 같아요.",
